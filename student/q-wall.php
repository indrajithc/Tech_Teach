...
<div class="row mycustclass80869191" id="q_wall80869191" style="top: -61px !important; min-height:725px !important;">
        ...
        <div class="actualContent80869191">
            ...
            <div class="row discription80869191">
            	<div class="col-md-8 myclassforcol80869191_one" id="mainRepalys_viewArea80869191">
                   ...
                   <form id="addAreplayForthis" name="addAreplayForthis">
                            <div class="col-md-offset-1 col-md-11" id="replayTeextArea_80869191">
                                <textarea  class="form-control replayTeextArea_80869191_area" placeholder=" do you know the answer .."  id="replayTeextArea_80869191_replay" name="replayTeextArea_80869191_replay" admin = "<?php echo substr( $_SESSION['st'] ,3); ?>"></textarea>
                            </div>
                ...
                <div class="col-md-4 myclassforcol80869191_two">
                    ...
                    <div class="hearfourdivcom80869191 hearfourdivcom80869191_2" id="hdearfourdivcom80869191_2">
                        ...
                        <?php 
							$query = "SELECT * FROM `favourite_question` WHERE admin = '".substr( $_SESSION['st'] ,3)."' ORDER BY `favourite_question`.`date` DESC ";
			$fvpost = $a->display($query);
				...
				foreach($fvpost as $val8086) {
                    ...
                    <div class="myallposts80869191" id="aftermypostadd80869191" admin="<?php echo substr( $_SESSION['st'] ,3); ?>">
                        	<h3><i class="fa fa-question">  my questions </i></h3>
                        </div>
                        
                        <?php  
			$query = "SELECT * FROM `question` WHERE admin = '".substr( $_SESSION['st'] ,3)."' ORDER BY `question`.`date` DESC";
